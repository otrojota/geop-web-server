class WRegistrarse extends ZDialog {
    onThis_init(options) {
        this.mensaje.html = `<i class="fas fa-info mr-1"></i>Complete su información personal para registrarse en el GEOPORTAL. Se le enviará un código de verificación a la dirección de correo electrónico que ingrese, el que será requerido en el siguiente paso.`;
        this.alerta.hide();
        this.paso = 1; 
        this.paso2.hide();
    ...
    async onCmdOk_click() {
        ...
        if (this.paso == 1) {
            ...
            try {
                ...
                await zPost("iniciaRegistro.usu", {nombre:nombre, email:email});
                this.paso1.hide();
                this.paso2.show();
            ...
            try {
                ...
                await zPost("finalizaRegistro.usu", {email:email, codigo:codigo, pwd:pwd1});
